...
function MySQL.open(self, server, database, userid, password)
	...
	local assembly = reflection.Assembly.LoadFrom('resources/[DLC3]/dlc3_radarf/lib/MySql.Data.dll')
...
function MySQL.executeQuery(self, command)
...
function MySQL.getResults(self, mySqlCommand, fields)
