local weashop = {
	...
	menu = {
		...
		["Melee"] = {
			...
			name = "Melee",
			buttons = {
				{title = "Knife", name = "Knife", costs = 9500, description = {}, model = "WEAPON_Knife"},
				{title = "Nightstick", name = "Nightstick", costs = 7000, description = {}, model = "WEAPON_Nightstick"},
				{title = "Hammer", name = "Hammer", costs = 8000, description = {}, model = "WEAPON_HAMMER"},
				{title = "Bat", name = "Bat", costs = 7500, description = {}, model = "WEAPON_Bat"},
				{title = "Crowbar", name = "Crowbar", costs = 8000, description = {}, model = "WEAPON_Crowbar"},
				{title = "Golfclub", name = "Golfclub", costs = 8500, description = {}, model = "WEAPON_Golfclub"},
				{title = "Bottle", name = "Bottle", costs = 6900, description = {}, model = "WEAPON_Bottle"},
				{title = "Dagger", name = "Dagger", costs = 10000, description = {}, model = "WEAPON_Dagger"},
				{title = "Hatchet", name = "Hatchet", costs = 13000, description = {}, model = "WEAPON_Hatchet"},
				{title = "KnuckleDuster", name = "KnuckleDuster", costs = 15000, description = {}, model = "WEAPON_KnuckleDuster"},
				{title = "Machete", name = "Machete", costs = 12500, description = {}, model = "WEAPON_Machete"},
				{title = "Flashlight", name = "Flashlight", costs = 25000, description = {}, model = "WEAPON_Flashlight"},
				{title = "SwitchBlade", name = "SwitchBlade", costs = 18000, description = {}, model = "WEAPON_SwitchBlade"},
				{title = "Poolcue", name = "Poolcue", costs = 17000, description = {}, model = "WEAPON_Poolcue"},
				{title = "Wrench", name = "Wrench", costs = 18000, description = {}, model = "WEAPON_Wrench"},
				{title = "Battleaxe", name = "Battleaxe", costs = 18000, description = {}, model = "WEAPON_Battleaxe"},
			}
		},
		["Pistolets"] = {
			title = "Pistolets",
			name = "Pistolets",
			buttons = {
				--{title = "Pistol", name = "Pistol", costs = 229000, description = {}, model = "WEAPON_Pistol"},
				...
				{title = "SNS Pistol", name = "SNSPistol", costs = 19000, description = {}, model = "WEAPON_SNSPistol"},
				{title = "Heavy Pistol", name = "HeavyPistol", costs = 35000, description = {}, model = "WEAPON_HeavyPistol"},
				{title = "Vintage Pistol", name = "VintagePistol", costs = 40000, description = {}, model = "WEAPON_VintagePistol"},
				{title = "Marksman Pistol", name = "MarksmanPistol", costs = 38000, description = {}, model = "WEAPON_MarksmanPistol"},
				{title = "Revolver", name = "Revolver", costs = 46000, description = {}, model = "WEAPON_Revolver"},
				{title = "AP Pistol", name = "APPistol", costs = 150000, description = {}, model = "WEAPON_APPistol"},
...
{entering = {20.1861,-1107.66,28.797}, inside = {16.1861,-1111.66,50.797}, outside = {20.1861,-1107.66,28.797}},
{entering = {-663.432, -936.025,21.8292}, inside = {-668.432, -941.025,50.8292}, outside = {-663.432, -936.025,21.8292}},
{entering = {811.51, -2157.0,29.619}, inside = {806.51, -2161.0,60.619}, outside = {811.51, -2157.0,29.619}},
{entering = {-1305.34, -393.907,36.6958}, inside = {-13011.34, -398.907,60.6958}, outside = {-1305.34, -393.907,36.6958}},
{entering = {251.569, -48.5375,69.9411}, inside = {246.569, -53.5375,100.9411}, outside = {251.569, -48.5375,69.9411}},
}
