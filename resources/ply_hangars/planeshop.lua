...
local planeshop = {
	...
	menu = {
		...
		["Civil"] = {
			...
			name = "Civil",
			buttons = {
				{name = "Cuban 800", costs = 3000000, description = {}, model = "cuban800"},
				{name = "Dodo", costs = 6000000, description = {}, model = "dodo"},
				{name = "Duster", costs = 3500000, description = {}, model = "duster"},
				{name = "Luxor", costs = 8000000, description = {}, model = "luxor"},
				{name = "Mammatus", costs = 5000000, description = {}, model = "mammatus"},
				{name = "Mil-Jet", costs = 10000000, description = {}, model = "miljet"},
				{name = "Nimbus", costs = 7800000, description = {}, model = "nimbus"},
				{name = "Shamal", costs = 8000000, description = {}, model = "shamal"},
				{name = "Velum", costs = 5500000, description = {}, model = "velum"},
				{name = "Vestra", costs = 7000000, description = {}, model = "vestra"},
			}
		},
		["Militaire"] = {
			title = "Militaire",
			name = "Militaire",
			buttons = {
				--{name = "Besra", costs = 1, description = {}, model = "besra"},
				--{name = "Hydra", costs = 1, description = {}, model = "hydra"},
				{name = "Titan", costs = 12000000, description = {}, model = "titan"},
			}
		},
	}
}
...
function ShowPlaneshopBlips(bool)
	if bool and #planeshop_blips == 0 then
		for station,pos in pairs(planeshop_locations) do
			...
			AddTextComponentString('Tour de contrôle')
