...
-- end)
  ...
  --      AddTextComponentString("Bienvenue sur le serveur ~g~GFAV !.\n ~y~Pour plus d'informations tapez /help");
  --      SetNotificationMessage("CHAR_ALL_PLAYERS_CONF", "CHAR_ALL_PLAYERS_CONF", true, 1, "Discord: ", "https://discord.gg/d3ugTRn");
  --      SetNotificationMessage("CHAR_ALL_PLAYERS_CONF", "CHAR_ALL_PLAYERS_CONF", true, 1, "Forum: ", "https://gfav.fr");
