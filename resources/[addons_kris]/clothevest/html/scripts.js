...
$(document).ready(function(){
    ...
    document.onkeyup = function (keys) {
        if ( keys.which == 21 ) {
            resetMenu();
            $.post('http://clothevest/close', JSON.stringify({}));
        }
        //back
        if ( keys.which == 8 ) {
        ...
        if ( keys.which == 13 ) {
            ...
            if ( $('.menu').hasClass('outfits') ) {
                $.post('http://clothevest/outfit_pay', JSON.stringify({id: $('.buttons li.active').data('id'), price: $('.buttons li.active').data('price') }))
            }
            // Menu S habiller action de porter
            if ( $('.menu').hasClass('dressing')) {

                $.post('http://clothevest/outfit_wear', JSON.stringify({id: $('.buttons li.active').data('id') }));
            }

            // Menu des lunettes action d'acheter
            if ( $('.menu').hasClass('glasses') ) {
                $.post('http://clothevest/prop_pay', JSON.stringify({id: $('.buttons li.active').data('position') +1, price: $('.buttons li.active').data('price'), category: $('.buttons li.active').data('slug') }))
            }
            ...
            if ( $('.menu').hasClass('dressingGlasses')) {
                ...
                $.post('http://clothevest/prop_glasses_wear', JSON.stringify({id: $('.buttons li.active').data('id') }));
            }
            if ( $('.menu').hasClass('dressingHats')) {

                $.post('http://clothevest/prop_hats_wear', JSON.stringify({id: $('.buttons li.active').data('id') }));
            }
        ...
        if ( keys.which == 40 ) {
            ...
            if ( $('.menu').hasClass('outfits') ) {
                if (current.index() +2 > 10 ) {
                    ...
                    $('.buttons').append(e);
                    $.post('http://clothevest/outfit_switcher', JSON.stringify({id: clothesShopMenu.menu.outfits.buttons[parseInt(current.data('position') + 1)].id}));

                } else {
                    $.post('http://clothevest/outfit_switcher', JSON.stringify({id: $('.buttons li.active').data('id') }))
                }
            ...
            if ( $('.menu').hasClass('dressing') ) {
                if (current.index() +2 > 10 ) {
                    ...
                    $('.buttons').append(e);
                    $.post('http://clothevest/dressing_switcher', JSON.stringify({id: clothesShopMenu.menu.dressing.buttons[parseInt(current.data('position') + 1)].id}));

                } else {
                    $.post('http://clothevest/dressing_switcher', JSON.stringify({id: $('.buttons li.active').data('id') }))
                }
            ...
            if ( $('.menu').hasClass('dressingGlasses') ) {
                if (current.index() +2 > 10 ) {
                    ...
                    $('.buttons').append(e);
                    $.post('http://clothevest/glasses_dressing_switcher', JSON.stringify({id: current.data('position') +1}));

                } else {
                    $.post('http://clothevest/glasses_dressing_switcher', JSON.stringify({id: $('.buttons li.active').data('position') +1 }))
                }
            ...
            if ( $('.menu').hasClass('dressingHats') ) {
                if (current.index() +2 > 10 ) {
                    ...
                    $('.buttons').append(e);
                    $.post('http://clothevest/hats_dressing_switcher', JSON.stringify({id: current.data('position') +1}));

                } else {
                    $.post('http://clothevest/hats_dressing_switcher', JSON.stringify({id: $('.buttons li.active').data('position') +1 }))
                }
            ...
            if ( $('.menu').hasClass('hats') ) {
                if (current.index() +2 > 10 ) {
                    ...
                    $('.buttons').append(e);
                    $.post('http://clothevest/hat_switcher', JSON.stringify({id: clothesShopMenu.menu.hats.buttons[parseInt(current.data('position') + 1)].id}));

                } else {
                    $.post('http://clothevest/hat_switcher', JSON.stringify({id: $('.buttons li.active').data('id')}));
                }
            }
            if ( $('.menu').hasClass('glasses') ) {
                if (current.index() +2 > 10 ) {
                    ...
                    $('.buttons').append(e);
                    $.post('http://clothevest/glasses_switcher', JSON.stringify({id: clothesShopMenu.menu.glasses.buttons[parseInt(current.data('position') + 1)].id}));

                } else {
                    $.post('http://clothevest/glasses_switcher', JSON.stringify({id: $('.buttons li.active').data('id')}));
                }
            }
        }
        // UP
