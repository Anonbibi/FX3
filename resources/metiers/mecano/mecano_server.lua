function closures_mecano_server()
    local listMissions = {}
    ...
    AddEventHandler('es:playerLoaded', function(source)
        ...
        -- Here change id Job (allowed to withdraw/deposit )
            if(idjob == '35')then
                TriggerClientEvent('meca:ismecaok', source)
    ...
    RegisterServerEvent('mecano:finesGranted')
    AddEventHandler('mecano:finesGranted', function(t, amount, reason)
        TriggerClientEvent('chatMessage', source, 'GOUVERNMENT', {255, 0, 0}, GetPlayerName(t).. " à payé la facture de $"..amount.." pour" .. reason)
        TriggerClientEvent('mecano:payFines', t, amount, reason)
    end)
