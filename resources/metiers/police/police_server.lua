...
RegisterServerEvent('police:targetSaisirDyrtiMoney')
AddEventHandler('police:targetSaisirDyrtiMoney', function(t)
	TriggerClientEvent('chatMessage', source, 'GOUVERNMENT', {255, 0, 0}, saisirDyrtiMoney(t))
end)

RegisterServerEvent('police:targetSaisirIllegal')
AddEventHandler('police:targetSaisirIllegal', function(t)
	TriggerClientEvent('chatMessage', source, 'GOUVERNMENT', {255, 0, 0}, saisirIllegal(t))
end)

RegisterServerEvent('police:targetSaisirAllWeapon')
AddEventHandler('police:targetSaisirAllWeapon', function(t)
	TriggerClientEvent('chatMessage', source, 'GOUVERNMENT', {255, 0, 0}, saisirAllWeapon(t))
end)

RegisterServerEvent('police:targetSaisirNoAchaWeapon')
AddEventHandler('police:targetSaisirNoAchaWeapon', function(t)
	TriggerClientEvent('chatMessage', source, 'GOUVERNMENT', {255, 0, 0}, saisirNoAchaWeapon(t))
end)

RegisterServerEvent('police:targetSaisirRendreWeapon')
AddEventHandler('police:targetSaisirRendreWeapon', function(t)
