...
AddEventHandler('jail:teleportPlayer', function(amount)
	if(isHandCuffed == true) then
		SetEntityCoords(GetPlayerPed(-1), tonumber("1690.4"), tonumber("2645.32"), tonumber("45.165"))
		
		TriggerEvent('chatMessage', '^4[JAIL]', {0,0,0}, "Vous êtes en prison pour ^1".. amount .." seconds!")
		...
		Citizen.CreateThread(function()
			...
			TriggerEvent('chatMessage', '^4[JAIL]', {0,0,0}, "Vos armes sont confisquées")
		...
		TriggerEvent('chatMessage', source,'^4[JAIL]', {0,0,0}, "Citoyen en prison")
	end
end)
-- Jail addon end
